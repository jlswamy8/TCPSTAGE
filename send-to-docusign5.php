<?php
function SendToDocusign($myarray) {
//echo "in htdocs" ;
//echo $myarray[pemail] ;
$integratorKey = '1bafb0b9-7cae-46e6-9908-05ec9f1ccf92';
$email = 'vasu@ccprllc.com';
$password = 'docusign4capstone';
$recipient_email = $myarray[pemail];
$name = 'Joe Capstone';
$document_name = '/home/capstone/forms/fullform.pdf';
