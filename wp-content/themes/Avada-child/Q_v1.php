<?php
// Template Name: Execute Documents Qualified 
get_header(); ?>  
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>><td colspan="3"><b> PARTICIPANT IDENTIFICATION</b> </td><td></td><td></td> </tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>> <td><hr> </td><td> </td><td> </td> <td></td><td></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="2"><div class="caption_fields">Last Name</div><div class="error_message"><?php if (isset($plname_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="plname" value="<?php if (isset($_POST['plname']) && strlen(trim($_POST['plname'])) > 0) echo $_POST['plname']; else echo ""; ?>" />
...
</td><td colspan="3"><div class="caption_fields">Social Security Num</div><div class="error_message"><?php if (isset($pSSN_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pSSN" value="<?php if (isset($_POST['pSSN']) && strlen(trim($_POST['pSSN'])) > 0) echo $_POST['pSSN']; else echo ""; ?>" /></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="2"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($pcity_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pcity" value="<?php if (isset($_POST['pcity']) && strlen(trim($_POST['pcity'])) > 0) echo $_POST['pcity']; else echo ""; ?>" />
...
</td><td><div class="caption_fields">Zip</div><div class="error_message"><?php if (isset($pzip_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pzip" value="<?php if (isset($_POST['pzip']) && strlen(trim($_POST['pzip'])) > 0) echo $_POST['pzip']; else echo ""; ?>" /></td><td colspan="2"><div class="caption_fields">Home Phone</div><div class="error_message"><?php if (isset($phomephone_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="phomephone" value="<?php if (isset($_POST['phomephone']) && strlen(trim($_POST['phomephone'])) > 0) echo $_POST['phomephone']; else echo ""; ?>" /></td></tr>
...
</td><td></td><td colspan = "2" ><div class="caption_fields">Daytime Phone</div><div class="error_message"><?php if (isset($pdaytimephone_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pdaytimephone" value="<?php if (isset($_POST['pdaytimephone']) && strlen(trim($_POST['pdaytimephone'])) > 0) echo $_POST['pdaytimephone']; else echo ""; ?>" /></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>> <td><hr> </td><td> </td><td> </td> </tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>> <td><b> PHOTO IDENTIFICATION</b> </td><td></td><td></td> </tr>
...
</td><td><div class="caption_fields">ID Number</div><div class="error_message"><?php if (isset($pidnum_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pidnum" value="<?php if (isset($_POST['pidnum']) && strlen(trim($_POST['pidnum'])) > 0) echo $_POST['pidnum']; else echo ""; ?>" /></td><td colspan="2"><div class="caption_fields">Issuing Jurisdiction</div><div class="error_message"><?php if (isset($pissuer_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pissuer" value="<?php if (isset($_POST['pissuer']) && strlen(trim($_POST['pissuer'])) > 0) echo $_POST['pissuer']; else echo ""; ?>" /></td></tr>
...
</td><td colspan = "2" ><div class="caption_fields">Expiration Date</div><div class="error_message"><?php if (isset($pexpdate_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pexpdate" value="<?php if (isset($_POST['pexpdate']) && strlen(trim($_POST['pexpdate'])) > 0) echo $_POST['pexpdate']; else echo ""; ?>" /></td></tr>
