...
*
* @author  Tech Banker
* @package wp-mail-bank-business-edition/views/email-logs
* @version 2.0.0
*/
...
else
{
	...
	{
		$mb_email_logs_bulk_delete = wp_create_nonce("mb_email_logs_bulk_delete");
						...
						<form id="ux_frm_email_logs">
							<div class="form-body">
								...
								<div class="table-top-margin">
									...
									<input type="button" class="btn vivid-green" name="ux_btn_apply" id="ux_btn_apply" value="<?php echo $mb_email_logs_apply;?>" onclick="bulk_delete_email_logs()">
								</div>
