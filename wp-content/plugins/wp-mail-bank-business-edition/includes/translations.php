...
else
{
	...
	else
	{
		...
		$mb_choose_record_to_delete = __("Please choose at least 1 record to delete!","wp-mail-bank");
		$mb_confirm_bulk_delete = __("Are you sure you want to delete Email Logs?","wp-mail-bank");
		$mb_bulk_delete_email_logs =__("Selected Logs have been deleted Successfully","wp-mail-bank");
		...
		$mb_licensing_label = __("Licensing","wp-mail-bank");

		// Common Variables
		$mb_license_activated = __("Your License has been activated Successfully","wp-mail-bank");
		...
		// Error Logs
		$mb_mail_bank = __("Mail Bank","wp-mail-bank");
		$mb_error_logs_label = __("Error Logs","wp-mail-bank");
		$mb_error_logs_output_tooltip = __("In this field you would be able to see all PHP Errors","wp-mail-bank");
		$mb_download_error_logs = __("Download Error Logs","wp-mail-bank");
		$mb_clear_error_logs = __("Clear Error Logs","wp-mail-bank");
		$mb_error_logs_output = __("Output","wp-mail-bank");
		$mb_error_logs_message = __("Error Logs has been cleared successfully","wp-mail-bank");

		// Licensing
		$mb_licensing_important_notice_label = __("Important Notice!","wp-mail-bank");
		$mb_licensing_activate_license_label = __("Congratulations! You have recently purchased Mail Bank Business Edition and now you would need to activate the license in order to unlock it!","wp-mail-bank");
		$mb_licensing_validate_licanse_label = __("Kindly fill in the required details and click on Validate License to unlock it","wp-mail-bank");
		$mb_licensing_contact_us_label = __("If you face any issues activating the license, you may contact us at ","wp-mail-bank");

		$mb_licensing_product_key_label = __("Product Name","wp-mail-bank");
		$mb_licensing_current_version_label = __("Current Version","wp-mail-bank");
		$mb_licensing_website_url_label = __("Website URL","wp-mail-bank");
		$mb_licensing_order_id_label = __("Order ID","wp-mail-bank");
		$mb_licensing_api_key_label = __("API KEY","wp-mail-bank");
		$mb_licensing_validate_license_label = __("Validate License","wp-mail-bank");

		$mb_licensing_installed_product_tooltip = __("This field shows your Installed Product","wp-mail-bank");
		$mb_licensing_product_version_tooltip = __("This field shows your Installed Product Version","wp-mail-bank");
		$mb_licensing_website_site = __("This field shows your Website URL","wp-mail-bank");
		$mb_licensing_order_id_tooltip = __("Please provide your Order ID  which you have received after purchasing the Product. This will be used for Validating the License","wp-mail-bank");
		$mb_licensing_api_key_tooltip = __("Please provide your API Key which you have received after purchasing the Product. This will be used for Validating the License","wp-mail-bank");
		$mb_licensing_order_id_placeholder = __("Please provide Order ID received after making the purchase","wp-mail-bank");
		$mb_licensing_api_key_placeholder = __("Please provide API Key received after making the purchase","wp-mail-bank");
	}
}
?>
