...
*
* @author  Tech Banker
* @package wp-mail-bank-business-edition/views/email-setup
* @version 2.0.0
*/
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="ux_txt_reply_to" id="ux_txt_reply_to" value="<?php echo isset($email_configuration_array["reply_to"]) ? esc_html($email_configuration_array["reply_to"]) : "";?>" placeholder="<?php echo $mb_email_configuration_reply_to_placeholder;?>">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="ux_txt_cc" id="ux_txt_cc" value="<?php echo isset($email_configuration_array["cc"]) ? $email_configuration_array["cc"] : "" ?>" placeholder="<?php echo $mb_email_configuration_cc_email_placeholder; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="ux_txt_bcc" id="ux_txt_bcc" value="<?php echo isset($email_configuration_array["bcc"]) ? $email_configuration_array["bcc"] : "" ?>" placeholder="<?php echo $mb_email_configuration_bcc_email_placeholder; ?>">
												</div>
											</div>
										</div>
										<div class="form-group">
