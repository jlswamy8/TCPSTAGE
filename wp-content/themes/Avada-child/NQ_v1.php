<?php
// Template Name: Execute Documents Non Qualified 
get_header(); ?>  
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Type of ID</div><div class="error_message"><?php if (isset($pidtype_invalid_flag)) echo "Invalid Value"; ?></div><select  class="input_width" name="pidtype">
<option value=" " <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], ' ') == 0) echo 'selected'; ?> >         </option>
<option value="Drivers License" <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], 'Drivers License') == 0) echo 'selected'; ?> >Drivers License</option>
<option value="State ID" <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], 'State ID') == 0) echo 'selected'; ?> >State ID</option>
<option value="Military ID" <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], 'Military ID') == 0) echo 'selected'; ?> >Military ID</option>
<option value="Passport" <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], 'Passport') == 0) echo 'selected'; ?> >Passport</option>
<option value="Student ID" <?php if (isset($_POST['pidtype']) && strcasecmp($_POST['pidtype'], 'Student ID') == 0) echo 'selected'; ?> >Student ID</option>
</select>
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Account Type </div><div class="error_message"><?php if (isset($paccttype_invalid_flag)) echo "Invalid Value"; ?></div></td><td><div class="input_width"><input type="radio" name="paccttype" value="Non Qualified" checked <?php if (isset($_POST['paccttype']) && strcasecmp($_POST['paccttype'],'Non Qualified')== 0) echo 'checked';  ?> /> Non Qualified</div></td><td>
</td><td></td></tr>
