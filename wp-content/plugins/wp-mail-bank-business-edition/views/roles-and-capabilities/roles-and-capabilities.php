...
*
* @author  Tech Banker
* @package wp-mail-bank-business-edition/views/roles-and-capabilities
* @version 2.0.0
*/
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_administrator">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_admin" disabled="disabled" checked="checked" id="ux_chk_licensing_admin" value="1">
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_author">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_author" id="ux_chk_licensing_author" value="1" <?php echo isset($author) && $author[8] =="1" ? "checked = checked" : ""?>>
															<?php echo $mb_licensing_label; ?>
														</td>
														<td>
														</td>
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_editor">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_editor" id="ux_chk_licensing_editor" value="1" <?php echo isset($editor) && $editor[8] =="1" ? "checked = checked" : ""?>>
															<?php echo $mb_licensing_label; ?>
														</td>
														<td>
														</td>
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_contributor">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_contributor" id="ux_chk_licensing_contributor" value="1" <?php echo isset($contributor) && $contributor[8] =="1" ? "checked = checked" : ""?>>
															<?php echo $mb_licensing_label; ?>
														</td>
														<td>
														</td>
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_subscriber">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_subscriber" id="ux_chk_licensing_subscriber" value="1" <?php echo isset($subscriber) && $subscriber[8] =="1" ? "checked = checked" : ""?>>
															<?php echo $mb_licensing_label; ?>
														</td>
														<td>
														</td>
											...
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_other_roles_privileges">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<input type="checkbox" name="ux_chk_licensing_others" id="ux_chk_licensing_others" value="1" <?php echo isset($other_privileges) && $other_privileges[8] =="1" ? "checked = checked" : ""?>>
															<?php echo $mb_licensing_label; ?>
														</td>
														<td>
														</td>
