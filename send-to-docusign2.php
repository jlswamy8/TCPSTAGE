...
class DocuSignSample
{
    ...
    {
        $username = "vasu@ccprllc.com";
        $password = "docusign4capstone";
        $integrator_key = "1bafb0b9-7cae-46e6-9908-05ec9f1ccf92";     
            ...
            if(isset($loginInformation) && count($loginInformation) > 0)
            {
                ...
                if(isset($loginInformation))
                {
                    ...
                    if(!empty($accountId))
                    {
                        ...
                        $templateRole->setEmail("vasu_vijay@yahoo.com");
                        $templateRole->setName("Joe Capstone");
                        ...
                        $envelop_definition->setTemplateId("1");
