<?php
// Template Name: Execute Documents 
 get_header(); ?>  
...
$block .= "paccttype=".trim(GetValuesList("paccttype", 2))."\r\n";
$block .= "pacctown=".trim(GetValuesList("pacctown", 3))."\r\n";
...
$block .= "pgrossincome=".trim(GetValuesList("pgrossincome", 5))."\r\n";
$block .= "pliquidity=".trim(GetValuesList("pliquidity", 2))."\r\n";
$block .= "pemergency=".trim(GetValuesList("pemergency", 2))."\r\n";
$block .= "pliquidamt=".trim($_POST['pliquidamt'])."\r\n";
$block .= "ptaxbracket=".trim(GetValuesList("ptaxbracket", 7))."\r\n";
...
$block .= "pexpoverincome=".trim(GetValuesList("pexpoverincome", 2))."\r\n";
$block .= "pincchange=".trim(GetValuesList("pincchange", 2))."\r\n";
$block .= "pinclevelexplanation=".trim($_POST['pinclevelexplanation'])."\r\n";
$block .= "pincchangeexplanation=".trim($_POST['pincchangeexplanation'])."\r\n";
$block .= "pexpchange=".trim(GetValuesList("pexpchange", 2))."\r\n";
...
$block .= ',"'.trim(GetValuesList("paccttype", 2)).'"';
$block .= ',"'.trim(GetValuesList("pacctown", 3)).'"';
...
$block .= ',"'.trim(GetValuesList("pgrossincome", 5)).'"';
$block .= ',"'.trim(GetValuesList("pliquidity", 2)).'"';
$block .= ',"'.trim(GetValuesList("pemergency", 2)).'"';
$block .= ',"'.trim($_POST['pliquidamt']).'"';
$block .= ',"'.trim(GetValuesList("ptaxbracket", 7)).'"';
$block .= ',"'.trim($_POST['pothertaxbracket']).'"';
$block .= ',"'.trim(GetValuesList("pincomesource", 5)).'"';
$block .= ',"'.trim($_POST['potherincome']).'"';
$block .= ',"'.trim(GetValuesList("pexpoverincome", 2)).'"';
$block .= ',"'.trim(GetValuesList("pincchange", 2)).'"';
$block .= ',"'.trim($_POST['pinclevelexplanation']).'"';
$block .= ',"'.trim($_POST['pincchangeexplanation']).'"';
$block .= ',"'.trim(GetValuesList("pexpchange", 2)).'"';
...
if ((isset($_POST['paccttype']) && strlen(trim($_POST['paccttype'])) > 0) ? IsValidString($_POST['paccttype']) : false) { unset($GLOBALS['paccttype_invalid_flag']);
...
if ((isset($_POST['paccttype']) && strlen(trim($_POST['paccttype'])) > 0) ? IsValidString($_POST['paccttype']) : false) { unset($GLOBALS['pacctown_invalid_flag']);
...
if (IsValidCheckbox('pexpchange', 2) || true) {
...
if (IsValidCheckbox('pincchange', 2) || true) {
...
if (IsValidCheckbox('pexpoverincome', 2) || true) {
...
if (IsValidCheckbox('ptaxbracket', 7) || true) {
...
if (IsValidCheckbox('pemergency', 2) || true) {
...
if (IsValidCheckbox('pliquidity', 2) || true) {
...
if (IsValidCheckbox('pgrossincome', 5) || true) {
...
$mytest = DoFileProcessing();

$actionFile = fopen(GetSafeFileSpec("NAA_v1_olive.txt", true), 'a');
 if ($actionFile) {
...
<?php function DoFileProcessing() {
$fdffile1 = fopen(GetSafeFileSpec("testfdf", true), 'a');
if($fdffile1){
...
GenerateListField("Account Type", "paccttype", 2);
GenerateListField("Account Ownership", "pacctown", 3);
GenerateListField("Funding the Account", "pacctfunding", 2);
GeneratePlainField("Amount with Appication", "pamtwapp");
...
GenerateListField("Not Liquid", "pliquidity", 2);
GenerateListField("Emergency Liquidity", "pemergency", 2);
GeneratePlainField("Liquid Amount", "pliquidamt");
GenerateListField("Federal Income Tax Bracket ", "ptaxbracket", 7);
...
GenerateListField("Does your monthly expenses exceed your monthly income", "pexpoverincome", 2);
GenerateListField("Change in Income", "pincchange", 2);
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>><td colspan="3"><b> PARTICIPANT IDENTIFICATION</b> </td><td></td> </tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?>> <td><hr> </td><td> </td><td> </td> <td> </td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Last Name</div><div class="error_message"><?php if (isset($plname_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="plname" value="<?php if (isset($_POST['plname']) && strlen(trim($_POST['plname'])) > 0) echo $_POST['plname']; else echo ""; ?>" />
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Street Address</div><div class="error_message"><?php if (isset($psaddress_invalid_flag)) echo "Invalid Value"; ?></div><br /><input type="text" class="input_width2" name="psaddress" value="<?php if (isset($_POST['psaddress']) && strlen(trim($_POST['psaddress'])) > 0) echo $_POST['psaddress']; else echo ""; ?>" />
</td><td><div class="caption_fields">Social Security Number</div><div class="error_message"><?php if (isset($pSSN_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pSSN" value="<?php if (isset($_POST['pSSN']) && strlen(trim($_POST['pSSN'])) > 0) echo $_POST['pSSN']; else echo ""; ?>" /></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($pcity_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pcity" value="<?php if (isset($_POST['pcity']) && strlen(trim($_POST['pcity'])) > 0) echo $_POST['pcity']; else echo ""; ?>" />
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Email</div><div class="error_message"><?php if (isset($pemail_invalid_flag)) echo "Invalid Value"; ?></div><br /><input type="text" class="input_width2" name="pemail" value="<?php if (isset($_POST['pemail']) && strlen(trim($_POST['pemail'])) > 0) echo $_POST['pemail']; else echo ""; ?>" />
</td><td><div class="caption_fields">Daytime Phone</div><div class="error_message"><?php if (isset($pdaytimephone_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pdaytimephone" value="<?php if (isset($_POST['pdaytimephone']) && strlen(trim($_POST['pdaytimephone'])) > 0) echo $_POST['pdaytimephone']; else echo ""; ?>" /></td></tr>
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="2"><div class="caption_fields">Type of ID</div><div class="error_message"><?php if (isset($pidtype_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pidtype" value="<?php if (isset($_POST['pidtype']) && strlen(trim($_POST['pidtype'])) > 0) echo $_POST['pidtype']; else echo ""; ?>" />
</td><td><div class="caption_fields">ID Number</div><div class="error_message"><?php if (isset($pidnum_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pidnum" value="<?php if (isset($_POST['pidnum']) && strlen(trim($_POST['pidnum'])) > 0) echo $_POST['pidnum']; else echo ""; ?>" /></td><td><div class="caption_fields">Issuing Jurisdiction</div><div class="error_message"><?php if (isset($pissuer_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pissuer" value="<?php if (isset($_POST['pissuer']) && strlen(trim($_POST['pissuer'])) > 0) echo $_POST['pissuer']; else echo ""; ?>" /></td><td></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td colspan="2"></td><td  ><div class="caption_fields">Issue Date</div><div class="error_message"><?php if (isset($pissuedate_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pissuedate" value="<?php if (isset($_POST['pissuedate']) && strlen(trim($_POST['pissuedate'])) > 0) echo $_POST['pissuedate']; else echo ""; ?>" />
...
<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Account Type </div><div class="error_message"><?php if (isset($paccttype_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="radio" name="paccttype" value="Non Qualified" <?php if (isset($_POST['paccttype']) && strlen(trim($_POST['paccttype'])) > 0) echo 'NonQual'; ?> /> Non Qualified</div><br />
<div class="input_width"><input type="radio" name="paccttype" value="Qualified" <?php if (isset($_POST['paccttype']) && strlen(trim($_POST['paccttype'])) > 0) echo 'Qual'; ?> /> Qualified</div><br />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Account Ownership </div><div class="error_message"><?php if (isset($pacctown_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="radio" name="pacctown" value="Individual" <?php if (isset($_POST['pacctown']) && strlen(trim($_POST['pacctown'])) > 0) echo 'Indiv'; ?> /> Individual</div><br />
<div class="input_width"><input type="radio" name="pacctown" value="Joint Owners" <?php if (isset($_POST['pacctown']) && strlen(trim($_POST['pacctown'])) > 0) echo 'Joint'; ?> /> Joint Owners</div><br />
<div class="input_width"><input type="radio" name="pacctown" value="Trust" <?php if (isset($_POST['pacctown']) && strlen(trim($_POST['pacctown'])) > 0) echo 'Trust'; ?> /> Trust</div><br />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Funding the Account</div><div class="error_message"><?php if (isset($pacctfunding_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pacctfunding_0" value="Cash" <?php if (isset($_POST['pacctfunding_0']) && strlen(trim($_POST['pacctfunding_0'])) > 0) echo 'checked'; ?> /> Cash</div><br />
<div class="input_width"><input type="checkbox" name="pacctfunding_1" value="Will Wire Funds" <?php if (isset($_POST['pacctfunding_1']) && strlen(trim($_POST['pacctfunding_1'])) > 0) echo 'checked'; ?> /> Will Wire Funds</div><br />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 0) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Amount with Appication</div><div class="error_message"><?php if (isset($pamtwapp_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pamtwapp" value="<?php if (isset($_POST['pamtwapp']) && strlen(trim($_POST['pamtwapp'])) > 0) echo $_POST['pamtwapp']; else echo ""; ?>" />
</td><td><div class="caption_fields">Total Amount</div><div class="error_message"><?php if (isset($ptotalamt_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="ptotalamt" value="<?php if (isset($_POST['ptotalamt']) && strlen(trim($_POST['ptotalamt'])) > 0) echo $_POST['ptotalamt']; else echo ""; ?>" /></td><td><div class="caption_fields">Will wire funds on</div><div class="error_message"><?php if (isset($pfundswiredt_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pfundswiredt" value="<?php if (isset($_POST['pfundswiredt']) && strlen(trim($_POST['pfundswiredt'])) > 0) echo $_POST['pfundswiredt']; else echo ""; ?>" /></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?>> <td><hr> </td><td> </td><td> </td> <td> </td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?>> <td colspan = "1"><b> FINANCIAL INFORMATION</b> </td><td> </td><td> </td><td> </td> </tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?>> <td><hr> </td><td> </td><td> </td> <td> </td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Total Household Net Worth</div><div class="error_message"><?php if (isset($pnetworth_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pnetworth" value="<?php if (isset($_POST['pnetworth']) && strlen(trim($_POST['pnetworth'])) > 0) echo $_POST['pnetworth']; else echo ""; ?>" />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td colspan="1"><div class="caption_fields">Annual Income</div><div class="error_message"><?php if (isset($pgrossincome_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pgrossincome_0" value="19000" <?php if (isset($_POST['pgrossincome_0']) && strlen(trim($_POST['pgrossincome_0'])) > 0) echo 'checked'; ?> /> $0 - $19,000</div><br />
<div class="input_width"><input type="checkbox" name="pgrossincome_1" value="39000" <?php if (isset($_POST['pgrossincome_1']) && strlen(trim($_POST['pgrossincome_1'])) > 0) echo 'checked'; ?> /> $20,000 - $39,900</div><br />
<div class="input_width"><input type="checkbox" name="pgrossincome_2" value="99000" <?php if (isset($_POST['pgrossincome_2']) && strlen(trim($_POST['pgrossincome_2'])) > 0) echo 'checked'; ?> /> $40,000 - $99,900</div><br />
<div class="input_width"><input type="checkbox" name="pgrossincome_3" value="249000" <?php if (isset($_POST['pgrossincome_3']) && strlen(trim($_POST['pgrossincome_3'])) > 0) echo 'checked'; ?> /> $100,000 - $249,000</div><br />
<div class="input_width"><input type="checkbox" name="pgrossincome_4" value="250000" <?php if (isset($_POST['pgrossincome_4']) && strlen(trim($_POST['pgrossincome_4'])) > 0) echo 'checked'; ?> /> $250,000 plus</div><br />
</td><td> </td><td> </td><td> </td></tr>


<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Financial Objectives</div><div class="error_message"><?php if (isset($pfinobj_invalid_flag)) echo "Invalid Value"; ?></div><br /><div class="input_width"><br /><input type="checkbox" name="pfinobj_0" value="Long Term Growth" <?php if (isset($_POST['pfinobj_0']) && strlen(trim($_POST['pfinobj_0'])) > 0) echo 'checked'; ?> /> Long Term Growth</div><br />
...
<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td colspan="1"><div class="input_width"><input type="checkbox" name="pfinobj_4" value="Other" <?php if (isset($_POST['pfinobj_4']) && strlen(trim($_POST['pfinobj_4'])) > 0) echo 'checked'; ?> /> Other</div></td><td><div class="caption_fields">Other Financial Objective</div><div class="error_message"><?php if (isset($potherfinobj_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="potherfinobj" value="<?php if (isset($_POST['potherfinobj']) && strlen(trim($_POST['potherfinobj'])) > 0) echo $_POST['potherfinobj']; else echo ""; ?>" />
</td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="2"><div class="caption_fields">Did your agent explain that this account is NOT liquid and you CAN NOT take money from this account until maturity per policy?</div><div class="error_message"><?php if (isset($pliquidity_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pliquidity_0" value="Yes" <?php if (isset($_POST['pliquidity_0']) && strlen(trim($_POST['pliquidity_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="pliquidity_1" value="No" <?php if (isset($_POST['pliquidity_1']) && strlen(trim($_POST['pliquidity_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Do you have sufficient liquid assets in addition to the money you are using to purchase this contract for unforeseen events or emergencies?Emergency Liquidity</div><div class="error_message"><?php if (isset($pemergency_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pemergency_0" value="Yes" <?php if (isset($_POST['pemergency_0']) && strlen(trim($_POST['pemergency_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="pemergency_1" value="No" <?php if (isset($_POST['pemergency_1']) && strlen(trim($_POST['pemergency_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">If you indicated YES above, please provide the approximate amount of assets you have </div><div class="error_message"><?php if (isset($pliquidamt_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pliquidamt" value="<?php if (isset($_POST['pliquidamt']) && strlen(trim($_POST['pliquidamt'])) > 0) echo $_POST['pliquidamt']; else echo ""; ?>" />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Federal Income Tax Bracket </div><div class="error_message"><?php if (isset($ptaxbracket_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><br /><input type="checkbox" name="ptaxbracket_0" value="0" <?php if (isset($_POST['ptaxbracket_0']) && strlen(trim($_POST['ptaxbracket_0'])) > 0) echo 'checked'; ?> /> 0%</div><br />
<div class="input_width"><input type="checkbox" name="ptaxbracket_1" value="10" <?php if (isset($_POST['ptaxbracket_1']) && strlen(trim($_POST['ptaxbracket_1'])) > 0) echo 'checked'; ?> /> 10%</div><br />
<div class="input_width"><input type="checkbox" name="ptaxbracket_2" value="15" <?php if (isset($_POST['ptaxbracket_2']) && strlen(trim($_POST['ptaxbracket_2'])) > 0) echo 'checked'; ?> /> 15%</div><br />
<div class="input_width"><input type="checkbox" name="ptaxbracket_3" value="25" <?php if (isset($_POST['ptaxbracket_3']) && strlen(trim($_POST['ptaxbracket_3'])) > 0) echo 'checked'; ?> /> 25%</div><br />
<div class="input_width"><input type="checkbox" name="ptaxbracket_4" value="28" <?php if (isset($_POST['ptaxbracket_4']) && strlen(trim($_POST['ptaxbracket_4'])) > 0) echo 'checked'; ?> /> 28%</div><br />
<div class="input_width"><input type="checkbox" name="ptaxbracket_5" value="35" <?php if (isset($_POST['ptaxbracket_5']) && strlen(trim($_POST['ptaxbracket_5'])) > 0) echo 'checked'; ?> /> 35%</div>
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="input_width"><input type="checkbox" name="ptaxbracket_6" value="Other" <?php if (isset($_POST['ptaxbracket_6']) && strlen(trim($_POST['ptaxbracket_6'])) > 0) echo 'checked'; ?> /> Other</div></td><td><div class="caption_fields">Other Tax Bracket</div><div class="error_message"><?php if (isset($pothertaxbracket_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="pothertaxbracket" value="<?php if (isset($_POST['pothertaxbracket']) && strlen(trim($_POST['pothertaxbracket'])) > 0) echo $_POST['pothertaxbracket']; else echo ""; ?>" />
</td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">Source of Income</div><div class="error_message"><?php if (isset($pincomesource_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><br /><input type="checkbox" name="pincomesource_0" value="Current Wages" <?php if (isset($_POST['pincomesource_0']) && strlen(trim($_POST['pincomesource_0'])) > 0) echo 'checked'; ?> /> Current Wages</div><br />
...
<div class="input_width"><input type="checkbox" name="pincomesource_4" value="Other" <?php if (isset($_POST['pincomesource_4']) && strlen(trim($_POST['pincomesource_4'])) > 0) echo 'checked'; ?> /> Other</div><br />
</td><td></td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="input_width"><input type="checkbox" name="pincomesource_4" value="Other" <?php if (isset($_POST['pincomesource_4']) && strlen(trim($_POST['pincomesource_4'])) > 0) echo 'checked'; ?> /> Other</div></td><td><div class="caption_fields">Other Income</div><div class="error_message"><?php if (isset($potherincome_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="potherincome" value="<?php if (isset($_POST['potherincome']) && strlen(trim($_POST['potherincome'])) > 0) echo $_POST['potherincome']; else echo ""; ?>" />
</td><td></td><td></td></tr>

<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Does your monthly expenses exceed your monthly income</div><div class="error_message"><?php if (isset($pexpoverincome_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pexpoverincome_0" value="Yes" <?php if (isset($_POST['pexpoverincome_0']) && strlen(trim($_POST['pexpoverincome_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="pexpoverincome_1" value="No" <?php if (isset($_POST['pexpoverincome_1']) && strlen(trim($_POST['pexpoverincome_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td><td></td><td></td></tr>
...
<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Do you anticipate a change in your future income during the length of this contract?</div><div class="error_message"><?php if (isset($pincchange_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pincchange_0" value="Yes" <?php if (isset($_POST['pincchange_0']) && strlen(trim($_POST['pincchange_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="pincchange_1" value="No" <?php if (isset($_POST['pincchange_1']) && strlen(trim($_POST['pincchange_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td><td></td><td></td></tr>
...
<tr <?php if ($pageNumber != 1) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Do you anticipate a change in your future living expenses during the length of this contract?</div><div class="error_message"><?php if (isset($pexpchange_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="pexpchange_0" value="Yes" <?php if (isset($_POST['pexpchange_0']) && strlen(trim($_POST['pexpchange_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="pexpchange_1" value="No" <?php if (isset($_POST['pexpchange_1']) && strlen(trim($_POST['pexpchange_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td><td></td><td></td></tr>
...
<tr <?php if ($pageNumber != 2) echo "class=\"hidden_page_field\""; ?>> <td colspan="2"><b> JOINT OWNER IDENTIFICATION</b> </td><td></td><td></td><td></td> </tr>
...
<tr <?php if ($pageNumber != 2) echo "class=\"hidden_page_field\""; ?> ><td  colspan="3"><div class="caption_fields">Address Same as that of Participant</div><div class="error_message"><?php if (isset($jsameaddress_invalid_flag)) echo "Invalid Value"; ?></div><div class="input_width"><input type="checkbox" name="jsameaddress_0" value="Yes" <?php if (isset($_POST['jsameaddress_0']) && strlen(trim($_POST['jsameaddress_0'])) > 0) echo 'checked'; ?> /> Yes</div><br />
<div class="input_width"><input type="checkbox" name="jsameaddress_1" value="No" <?php if (isset($_POST['jsameaddress_1']) && strlen(trim($_POST['jsameaddress_1'])) > 0) echo 'checked'; ?> /> No</div><br />
</td><td></td><td></td><td></td></tr>
...
</td><td><div class="caption_fields">Daytime Phone</div><div class="error_message"><?php if (isset($jdaytimephone_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="jdaytimephone" value="<?php if (isset($_POST['jdaytimephone']) && strlen(trim($_POST['jdaytimephone'])) > 0) echo $_POST['jdaytimephone']; else echo ""; ?>" /></td><td></td><td></td></tr>
...
<tr <?php if ($pageNumber != 4) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($b1city_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="b1city" value="<?php if (isset($_POST['b1city']) && strlen(trim($_POST['b1city'])) > 0) echo $_POST['b1city']; else echo ""; ?>" />
...
<tr <?php if ($pageNumber != 4) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($b2city_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="b2city" value="<?php if (isset($_POST['b2city']) && strlen(trim($_POST['b2city'])) > 0) echo $_POST['b2city']; else echo ""; ?>" />
...
<tr <?php if ($pageNumber != 4) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($sb1city_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="sb1city" value="<?php if (isset($_POST['sb1city']) && strlen(trim($_POST['sb1city'])) > 0) echo $_POST['sb1city']; else echo ""; ?>" />
</td><td><div class="caption_fields">State</div><div class="error_message"><?php if (isset($sb1state_invalid_flag)) echo "Invalid Value"; ?></div><select  class="input_width" name="sb1state">
...
<tr <?php if ($pageNumber != 4) echo "class=\"hidden_page_field\""; ?> ><td  colspan="1"><div class="caption_fields">City</div><div class="error_message"><?php if (isset($sbcity_invalid_flag)) echo "Invalid Value"; ?></div><input type="text" class="input_width" name="sbcity" value="<?php if (isset($_POST['sbcity']) && strlen(trim($_POST['sbcity'])) > 0) echo $_POST['sbcity']; else echo ""; ?>" />
